...
$query = 'SELECT * FROM merk ORDER BY id_merk ASC';
...
<head>
    ...
    <title>Daftar Merk Sparepart | Bengkel Bengawan</title>
    ...
    <div class="content">
        <div class="table-container">
            <h2 style="margin-top: 0; color: #333; text-align: left; border-bottom: 1px solid #eee; padding-bottom: 15px; margin-bottom: 20px;">
                <i class="fas fa-industry" style="color: #d32f2f;"></i> Daftar Merk Sparepart
            </h2>
            ...
            <?php endif; ?>
             ...
             <div style="text-align: left;">
                <a href="addmerk.php" class="btn btn-add"><i class="fas fa-plus"></i> Tambah Merk Sparepart</a>
             </div>
                ...
                <tbody>
                    <?php 
                     ...
                     if($result && mysqli_num_rows($result) > 0 ) {
                        ...
                        echo "<tr><td colspan='3' style='text-align:center; padding: 20px;'>Tidak ada data merk sparepart</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
